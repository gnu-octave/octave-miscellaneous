...
<dt class="deftypefn" id="index-_0028m_002c"><span class="category-def">Function File: </span><span><code class="def-type">colorboard</code> <strong class="def-name">(<var class="var">m</var>,</strong> <code class="def-code-arguments"><var class="var">palette</var>, <var class="var">options</var>)</code><a class="copiable-link" href="#index-_0028m_002c"></a></span></dt>
