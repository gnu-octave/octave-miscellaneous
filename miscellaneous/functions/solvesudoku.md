...
<dt class="deftypefn" id="index-ntrial_005d"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">x</var>,</code> <strong class="def-name"><var class="var">ntrial</var>]</strong> <code class="def-code-arguments">= solvesudoku (<var class="var">s</var>)</code><a class="copiable-link" href="#index-ntrial_005d"></a></span></dt>
