...
<dt class="deftypefn" id="index-nze"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">y</var>, <var class="var">f</var>] =</code> <strong class="def-name">nze</strong> <code class="def-code-arguments">(<var class="var">x</var>)</code><a class="copiable-link" href="#index-nze"></a></span></dt>
