...
<dt class="deftypefn" id="index-partint_0028n_0029"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">p</var> =</code> <strong class="def-name">partint(<var class="var">n</var>)</strong><a class="copiable-link" href="#index-partint_0028n_0029"></a></span></dt>
<dd>
