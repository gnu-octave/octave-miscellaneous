...
<dt class="deftypefn def-line" id="index-legendrepoly"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">coefs</var>=</code> <strong class="def-name">legendrepoly</strong> <code class="def-code-arguments">(<var class="var">order</var>,<var class="var">x</var>)</code><a class="copiable-link" href="#index-legendrepoly"></a></span></dt>
<dd> 
