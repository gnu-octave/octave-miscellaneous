...
<dt class="deftypefn def-line" id="index-zigzag"><span class="category-def">Function File: </span><span><strong class="def-name">zigzag</strong> <code class="def-code-arguments">(<var class="var">mtrx</var>)</code><a class="copiable-link" href="#index-zigzag"></a></span></dt>
