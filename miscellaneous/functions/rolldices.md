...
<dt class="deftypefn def-line" id="index-_0028n_0029"><span class="category-def">Function File: </span><span><code class="def-type">rolldices</code> <strong class="def-name">(<var class="var">n</var>)</strong><a class="copiable-link" href="#index-_0028n_0029"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-_0028n_002c"><span class="category-def">Function File: </span><span><code class="def-type">rolldices</code> <strong class="def-name">(<var class="var">n</var>,</strong> <code class="def-code-arguments"><var class="var">nrep</var>, <var class="var">delay</var>)</code><a class="copiable-link" href="#index-_0028n_002c"></a></span></dt>
